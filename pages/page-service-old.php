<?php
/**
 * Template Name: SERVICE old（〜20210510）
 * 
 * @use /service
 */
 get_header();
...
<section>
  <div id="add" class="serviceAdd">
    <div class="mv mvFirst">
      <img class="ofi" alt="SERVICE" src="<?php echo get_template_directory_uri(); ?>/images/service/service_add_mv_02.jpg">
      <div class="mvInner">
    ...
    <div class="serviceList wrap-c">
      ...
      <a href="<?php echo home_url('/'); ?>service-old/ovx" class="serviceBox op" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
      ...
      <a href="<?php echo home_url('/'); ?>service-old/ccr" class="serviceBox op" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
       ...
       <a href="<?php echo home_url('/'); ?>service-old/retail-marketing" class="serviceBox op" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
        <figure><img alt="retail-marketing" src="<?php echo get_template_directory_uri(); ?>/images/service/service_bnr_retailm.png" style="border-radius: 5px;" width="297"  srcset="<?php echo get_template_directory_uri(); ?>/images/service/service_bnr_retailm.png 1x,<?php echo get_template_directory_uri(); ?>/images/service/service_bnr_retailm.png 2x"></figure>
        <div class="serviceBox__info">
          <h4>リテールマーケティング部</h4>
          <p>リテール企業様ならではのデジタルマーケティングや組織づくりの課題に対して、最適なテクノロジーの選定から運用体制構築までワンストップでサポートいたします。</p>
          <div class="serviceBox__arrow">
            <div class="btnArrow"></div>
          </div>
          <div class="sp sp-btnMore">
      ...
      <!--
      <div class="serviceBox2 bg-white">
      <div class="wrap-d">
          <a href="https://e-omnibus.co.jp/service/saisondsp"><h4>リテールマーケティング部</h4></a>
          <p>
リテール企業ならではのデジタルマーケティングや組織づくりの課題に対して、最適なテクノロジーの選定からプランニング・運用体制構築までワンストップでサービスを提供し、企業のデジタルトランスフォーメーションをサポートいたします。
          </p>
          <div class="alignC">
            <a href="https://e-omnibus.co.jp/service/retail-marketing" target="_blank" class="serviceBox2__btn">
              詳しくはこちら
...
<section>
  <div id="data" class="serviceData">
    ...
    <div class="serviceBox2 bg-white" data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
      <div class="wrap-d">
          <a href="https://e-omnibus.co.jp/service-old/saisondsp"><h4>セゾンDSP/DMP</h4></a>
          <p>(株)クレディセゾンによる約1500万人のネット会員データ・クレジットカードの決済データなどをもつ独自DMPとそれを活用したDSP。データから抽出された各ユーザー毎の購買傾向などをセグメント化し、デジタル広告配信・セグメントメール配信・DM配信など各種施策へと連携が可能です。<br>
          サービスページはこちら：<a target="_blank" href="https://e-omnibus.co.jp/service-old/saisondsp">https://e-omnibus.co.jp/service/saisondsp/</a>
          </p>
          <div class="alignC">
